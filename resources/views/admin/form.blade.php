...
<style>
    ...
    #hero {
        ...
        background: linear-gradient(45deg, rgba(86, 58, 250, 0.9) 0%, rgba(116, 15, 214, 0.9) 100%),
            url("{{ asset('assets/img_default/hero-bg.jpg') }}") center center no-repeat;
            ...
            <div class="col-12 col-md-9">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        @if (in_array($part->kode, ['foto1', 'foto2', 'seo_image', 'fotobg']))
                        ...
                        @if (in_array($part->kode, $formlink))
                            <div class="mb-3">
                                ...
                                <input style="background-color: rgb(242, 242, 242);" name="link" type="text" class="form-control mb-2" value="{{ old('link', $part->link) }}">
                                <small>Silahkan Masukan Link Bebas : Contoh ->>> <span
                                        style="font-weight: bold ">https://drive.google.com/drive/folders/1ccUAiN1bpXwhYYDtUHS-2jNP0a0bX1EW?usp=drive_link</span></small>
                        ...
                        @if (in_array($part->kode, ['foto1', 'foto2', 'seo_image', 'fotobg']))
                            <div class="mb-3">
                                ...
                                <br>
                                <a class="btn btn-sm btn-warning m-1" href="{{ asset('assets/img_default/foto_awal.png') }}" download>Unduh Foto1 Default</a>
                                <a class="btn btn-sm btn-warning m-1" href="{{ asset('assets/img_default/seo_awal.jpg') }}" download>Unduh Foto SEO Default</a>
                            </div>
