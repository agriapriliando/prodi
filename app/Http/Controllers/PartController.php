...
class PartController extends Controller
{
    public function index($slug)
    {
        ...
        return view('admin.dashboard', [
            ...
            'fotobg' => Part::where('prodi_id', $prodi->id)->where('kode', 'fotobg')->first(),
    ...
    public function edit($slug, $part)
    {
        ...
        $prodislug = User::find(Auth::user()->id)->prodis()->orderBy('id')->first();
        $formlink = [
        ...
        // return $formlink;
        $formNoteks = [
            'facebook', 'whatsapp', 'instagram', 'instagramembed', 'foto1', 'foto2', 'seo_image', 'fotobg'
        ];
        $user = User::find(Auth::user()->id)->prodis()->orderBy('id')->get();
