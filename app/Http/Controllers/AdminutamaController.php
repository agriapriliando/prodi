...
class AdminutamaController extends Controller
{
    ...
    public function storeprodi(Request $request)
    {
        ...
        // copy file default
        Storage::copy('img_default/seo_awal.jpg', 'img/' . $namaimg . '_seo.jpg');
        Storage::copy('img_default/foto_awal.png', 'img/' . $namaimg . '_foto1.png');
        Storage::copy('img_default/foto_awal.png', 'img/' . $namaimg . '_foto2.png');
        Storage::copy('img_default/foto_awal.png', 'img/' . $namaimg . '_fotobg.png');
        ...
        DB::transaction(function () use ($request, $namaimg, $akronim) {
            ...
            Part::insert([
                ...
                [
                    'prodi_id' => $prodi->id,
                    'teks' => '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3986.716202467262!2d113.91328457496803!3d-2.259531297720586!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2de34d256cd711a7%3A0x4530439c8bd6f779!2sIAKN%20Palangkaraya!5e0!3m2!1sen!2sid!4v1708671723765!5m2!1sen!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>',
                    'kode' => 'gmap',
                    'link' => '#',
                ],
                [
    ...
    public function destroyprodi($id)
    {
        ...
        $fotobg = Part::where('prodi_id', $id)->where('kode', 'fotobg')->first();
        // hapus foto
        Storage::delete($seoimage->link);
        Storage::delete($foto1->link);
        Storage::delete($foto2->link);
        Storage::delete($fotobg->link);
        $prodi->delete();
